...
export default function Navbar() {
    ...
    return (
        <div className="relative text-white z-30">
            <div className="grid gridLayout absolute z-30 top-0 w-full items-center">
                <div className="col-start-2 col-span-1 flex justify-between items-center">
                    <Link href="#">
                        <svg
                            width="16"
                            height="20"
                ...
                <div className="col-start-10 flex justify-between  items-center">
                ...
                <div className="col-start-11 flex justify-start">
