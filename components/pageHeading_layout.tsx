...
export default function PageHeading_layout(props: any) {
        ...
        <div>
            {props.img && (
                <div className="relative">
                    ...
                    <img className="w-full max-h-[700px] object-cover" src={props.img} alt={props.title + "_img"} />
                </div>
            )}
            <div className="flex justify-center">
                <div className="max-w-[1920px] lg:grid gridLayout">
                    <div
                        ...
                        style={{
                            marginTop: props.img ? (marginTopValue > 0 ? `-${marginTopValue}px` : "-50px") : 150,
                        }}
                    >
                        <h2 className="col-span-full text-center px-[20px]">{props.title}</h2>
                        <div className="lg:col-start-2 lg:col-span-7 col-start-1 col-span-full px-[20px] ">
                            {props.children}
                            <div className="flex w-full items-center justify-center">{props.button}</div>
                        </div>
                    </div>
                </div>
            </div>
